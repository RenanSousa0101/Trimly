...
export class SchedulingService {
    ...
    async createScheduling(clientId: number, providerId: number, serviceId: number, params: CreateSchedulingParams) {
        ...
        const createScheduling = await this.schedulingRepository.createScheduling(clientId, providerId, serviceId, { ...params, appointment_date: dayjs(params.appointment_date).toDate(), status: SchedulingStatus.Pending });
